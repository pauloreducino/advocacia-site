    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 w-full pt-28 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 items-center min-h-screen">
        ...
        <div className="flex flex-col">
          ...
          >
            Advocacia criminal e empresarial de alto padrão. Estratégia, sigilo
            e resultados — do primeiro contato ao trânsito em julgado.
          </p>
          ...
          <div className="flex flex-wrap gap-4 animate-fade-up-more">
            <a
              href={getWhatsAppUrl(
                "Olá, gostaria de agendar uma consulta com o Dr. Henrique.",
              )}
              target="_blank"
        ...
        >
          <div className="relative">
            ...
            <div
              className="relative w-[260px] sm:w-[300px] h-[380px] sm:h-[440px] rounded-t-sm overflow-hidden"
              style={{
                maskImage:
            ...
            >
              <Image
                src="/images/chief-executive.jpg"
                alt="Dr. Henrique - Advogado especialista em direito criminal e empresarial"
                fill
