...
const CONTATOS = [
  ...
  },
  {
    ...
    label: 'E-mail',
    valor: 'contato@escritorio.adv.br',
  ...
  },
  {
    ...
    label: 'Endereço',
    valor: 'Av. Paulista, 1811 · Sala 210 · Bela Vista · SP',
  ...
  },
  {
    ...
    label: 'Horários',
    valor: 'Seg–Sex: 8h–19h · Sáb: 9h–12h',
    href: null,
    externo: false,
  },
  {
    ...
    label: 'Modalidades',
    valor: 'Presencial · Online · Urgência',
    href: null,
    externo: false,
  },
  {
    ...
    label: 'LinkedIn',
    valor: 'linkedin.com/in/henriquecavalcante',
    ...
    >
      ...
      >
        {CONTATOS.map((c, i) => {
          ...
          const cls =
            'reveal group border border-gold/10 rounded p-6 hover:border-gold/35 transition-colors duration-300 bg-surface/50 hover:bg-surface';
      ...
      {/* Map placeholder */}
      <div
        className="reveal mt-10 rounded overflow-hidden border border-gold/10 bg-surface flex items-center justify-center"
        style={{ height: '280px' }}
        aria-label="Mapa de localização"
      >
        <div className="text-center">
          <svg
            className="text-gold/20 mx-auto mb-3"
            width="40"
            height="40"
            viewBox="0 0 24 24"
            fill="none"
          ...
          <p className="text-muted text-[13px]">
            Substitua por um Google Maps embed
          </p>
          <p className="text-muted/50 text-[11px] mt-1">
            Av. Paulista, 1811 · Sala 210 · São Paulo
          </p>
        </div>
      </div>
    </section>
