...
const QUICK_LINKS = [
  ...
  { label: 'Insights jurídicos', href: '/blog' },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-[10px] text-gold tracking-[2px] uppercase mt-1">Advocacia Premium</p>
            <p className="text-sm text-muted mt-4 leading-relaxed max-w-[240px]">
              Defesa jurídica de alto padrão para pessoas e empresas que não podem se dar ao luxo de errar.
            </p>
            <a
              href={getWhatsAppUrl()}
              target="_blank"
          ...
          {/* Quick links */}
          <div>
            <p className="text-[10px] text-gold tracking-[2px] uppercase mb-5">Navegação</p>
          ...
          {/* Contact */}
          <div>
            <p className="text-[10px] text-gold tracking-[2px] uppercase mb-5">Contato</p>
            <ul className="flex flex-col gap-3" role="list">
              {[
                ...
                { v: 'Seg–Sex: 8h–19h', href: '#contato' },
                { v: 'Sáb: 9h–12h (agendamento)', href: '#contato' },
              ].map((item) => (
                <li key={item.v}>
                  <a
                    href={item.href}
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
          <p className="text-[11px] text-muted/50">
            © {new Date().getFullYear()} Dr. Henrique Cavalcante · OAB/SP 123.456 · Todos os direitos reservados.
          </p>
          <p className="text-[10px] text-muted/35 max-w-sm text-right leading-relaxed">
            As informações deste site têm caráter informativo e não constituem consultoria jurídica.
          </p>
        </div>
      </div>
    </footer>
